...
function Experts({name,image,role,facebook,twitter,pinterest}) {
  return (
    <>
      <div className={` basis-[100%] mx-auto sm:basis-[30rem] md:basis-[25rem] bg-gradient-to-tr from-purple-500 via-violet-600 to-blue-700 transition-transform duration-300 hover:translate-y-[-.5%] ease-in-out parent-container relative overflow-hidden `} >
        <img src={image} className='w-100% h-[100%] z-[1] flex' alt="" />
